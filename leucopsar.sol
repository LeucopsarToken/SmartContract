...
contract LEUCOPSAR is Context, IERC20, Ownable {
    ...
    string private _name = "LEUCOPSAR";
    ...
    uint256 private minimumTokensBeforeSwap = 1000 * 10**5 * 10**9;

    address payable public charityAddress = 0x36c8be0108a3D5962e26e393995EfFBfFcDf3BE7; // Charity & Marekting
